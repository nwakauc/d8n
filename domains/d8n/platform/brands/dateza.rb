        ...
        def self.contract(brand:)
          BrandContract.new(
            ...
            media: BrandContract::MediaConfiguration.new(
              ...
              # A newly attached photo is visible immediately; moderation
              # still runs asynchronously afterwards and can flip it back to
              # hidden/rejected if it's later flagged. See
              # domains/media/photo_policy.rb.
