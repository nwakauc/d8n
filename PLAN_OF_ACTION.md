...
- Phase 4 architecture is accepted in ADR 0009. Slices 1 through 3 now provide profile publication, private locations, tenant-safe discovery, bilateral preferences, signed cursors, likes, passes, interaction exclusions, and atomic canonical matches. Capability-based HookUs ranking and the Date9ja strategy contract proof have not started.
