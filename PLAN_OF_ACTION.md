...
- Phase 4 architecture is accepted in ADR 0009. Slices 1 and 2 now provide public profile identifiers, private profile locations, shared tenant-safe eligibility, bilateral preferences, explicit HookUs strategy selection, and signed cursor discovery. Decisions, matches, and capability-based ranking have not started.
