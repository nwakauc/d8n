module Api
  module V1
    module Hq
      # Base for brand-scoped HQ endpoints. Ordinary authentication,
      # administrative assignment, session MFA, and action capability are four
      # separate server-authoritative checks.
