class WelcomeController < ApplicationController
  ...
  SERVICES = [
    ...
    { key: "matching", name: "D8N Match", domain: "Matching", status: "available",
      detail: "Shared eligibility, HookUs feeds, DateZA daily/Find compatibility, and Date9ja Explore/daily compatibility are available." },
    ...
    { key: "community", name: "D8N Community", domain: "Community", status: "preview",
      detail: "Date9ja moderated questions, answers, text stories, events/RSVPs, and Circles are available; migration and remaining parity surfaces are not." },
