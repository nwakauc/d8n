...
| [GOALS-AND-PERFORMANCE-SCOREBOARD.md](GOALS-AND-PERFORMANCE-SCOREBOARD.md) | Future design for explicit metric targets, direction-aware performance, and goal-change auditing | When implementing target tracking after Product Intelligence stabilizes |
